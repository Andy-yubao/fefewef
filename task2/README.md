...
Expected Diameter、Geometry、GDOP Mean、FIM E 和 Random 五种策略，共 50,000
...
正式 ED 使用 250 -> 100 -> 50 m 粗到细搜索、80 个 target samples 和 5 个
bounded-error quadrature nodes。研究脚本另比较 10/20/40/80 target samples、
3/5/9/17 error nodes、候选域、pruning、radius prior 与 hidden-R 修复前后。
...
- `results/tables/`：汇总、成对比较、bootstrap CI、敏感性、消融和收敛；
