...
_OPTIMIZATION_BASE = {
    **POLICIES['candidate_041_dynamic_open_route_deferred_cross_view'].planner_overrides,
    'focus_after_upper_bound_discovered': True,
}
for _policy_id, _overrides, _description in [
    ('candidate_043_interface_cost', {}, '041 plus correct clear-channel costs and discovered-upper-bound search stop.'),
    ('candidate_044_completion', {'completion_lookahead': True}, 'Two-observation completion rollout and endpoint routing.'),
    ('candidate_045_reception', {'exact_reception_region': True}, 'Conservative full-cell reception opportunities.'),
    ('candidate_046_shared_coverage', {'adaptive_search_certificate': True, 'shared_stop_measurements': True}, 'Shared stops and certified replacement of coverage anchors.'),
    ('candidate_047_probe_refine', {'optical_probe_limit': 2, 'refine_certificate': True, 'clear_region_routing': True}, 'Bounded optical probes, local cell refinement and clear-region entry.'),
    ('candidate_048_combined', {'completion_lookahead': True, 'exact_reception_region': True,
        'adaptive_search_certificate': True, 'shared_stop_measurements': True,
        'optical_probe_limit': 2, 'refine_certificate': True, 'clear_region_routing': True,
        'improve_greedy_route': True}, 'Combined opt-in optimization experiment; not a promoted champion.'),
    ('candidate_049_joint_completion', {'completion_lookahead': True,
        'joint_service_alternatives': True, 'admit_ready_sources': True,
        'defer_clear_to_route': True, 'improve_greedy_route': True,
        'optical_probe_limit': 2, 'refine_certificate': True, 'clear_region_routing': True},
        'Joint service alternatives, ready-source admission and route-priced clears.'),
    ('candidate_050_joint_coverage', {'completion_lookahead': True,
        'joint_service_alternatives': True, 'admit_ready_sources': True,
        'defer_clear_to_route': True, 'improve_greedy_route': True,
        'adaptive_search_certificate': True, 'shared_stop_measurements': True,
        'optical_probe_limit': 2, 'refine_certificate': True, 'clear_region_routing': True},
        'Joint completion plus shared and replaceable coverage stops.'),
    ('candidate_051_ring1140', {'completion_lookahead': True,
        'joint_service_alternatives': True, 'admit_ready_sources': True,
        'defer_clear_to_route': True, 'improve_greedy_route': True,
        'optical_probe_limit': 2, 'refine_certificate': True, 'clear_region_routing': True,
        'ring_radius_m': 1140.}, 'Joint completion on a separately certified 1140 m hexagon.'),
    ('candidate_052_probe40', {'completion_lookahead': True,
        'joint_service_alternatives': True, 'admit_ready_sources': True,
        'defer_clear_to_route': True, 'improve_greedy_route': True,
        'optical_probe_limit': 3, 'optical_probe_min_fraction': .40,
        'refine_certificate': True, 'clear_region_routing': True},
        'Joint completion with a lower occupancy threshold for bounded optical trials.'),
    ('candidate_053_free_order', {'completion_lookahead': True,
        'joint_service_alternatives': True, 'free_coverage_order': True,
        'preplanned_cross_view': False, 'defer_clear_to_route': True,
        'improve_greedy_route': True, 'shared_stop_measurements': True,
        'optical_probe_limit': 2, 'refine_certificate': True, 'clear_region_routing': True},
        'Unrestricted ordering of the same certified coverage set and all found sources; no angular guard.'),
    ('candidate_054_enroute_probe', {'completion_lookahead': True,
        'joint_service_alternatives': True, 'admit_ready_sources': True,
        'defer_clear_to_route': True, 'improve_greedy_route': True,
        'optical_probe_limit': 2, 'refine_certificate': True, 'clear_region_routing': True,
        'opportunistic_probe_budget': 24},
        'Aggressive zero-detour optical trials with a global and per-source budget.'),
    ('candidate_055_free_probe', {'completion_lookahead': True,
        'joint_service_alternatives': True, 'free_coverage_order': True,
        'preplanned_cross_view': False, 'defer_clear_to_route': True,
        'improve_greedy_route': True, 'shared_stop_measurements': True,
        'optical_probe_limit': 2, 'refine_certificate': True, 'clear_region_routing': True,
        'opportunistic_probe_budget': 24},
        'Unrestricted coverage order combined with bounded zero-detour optical trials.'),
    ('candidate_056_posterior_probe', {'completion_lookahead': True,
        'joint_service_alternatives': True, 'admit_ready_sources': True,
        'defer_clear_to_route': True, 'improve_greedy_route': True,
        'optical_probe_limit': 2, 'refine_certificate': True, 'clear_region_routing': True,
        'opportunistic_probe_budget': 24, 'posterior_completion': True},
        'Soft reception-radius posterior ranking plus bounded en-route optical trials.'),
    ('candidate_057_posterior_free', {'completion_lookahead': True,
        'joint_service_alternatives': True, 'free_coverage_order': True,
        'preplanned_cross_view': False, 'defer_clear_to_route': True,
        'improve_greedy_route': True, 'shared_stop_measurements': True,
        'optical_probe_limit': 2, 'refine_certificate': True, 'clear_region_routing': True,
        'opportunistic_probe_budget': 24, 'posterior_completion': True},
        'Free coverage ordering with soft posterior ranking and bounded optical trials.'),
    ('candidate_058_adaptive_cover', {'completion_lookahead': True,
        'joint_service_alternatives': True, 'free_coverage_order': True,
        'preplanned_cross_view': False, 'defer_clear_to_route': True,
        'improve_greedy_route': True, 'shared_stop_measurements': True,
        'optical_probe_limit': 2, 'refine_certificate': True, 'clear_region_routing': True,
        'adaptive_search_certificate': True, 'aggressive_shared_search': True,
        'adaptive_anchor_positions': True},
        'Shift future search stops under a full outer-cell coverage certificate and accumulate shared scans.'),
    ('candidate_059_adaptive_probe', {'completion_lookahead': True,
        'joint_service_alternatives': True, 'free_coverage_order': True,
        'preplanned_cross_view': False, 'defer_clear_to_route': True,
        'improve_greedy_route': True, 'shared_stop_measurements': True,
        'optical_probe_limit': 2, 'refine_certificate': True, 'clear_region_routing': True,
        'adaptive_search_certificate': True, 'aggressive_shared_search': True,
        'adaptive_anchor_positions': True, 'opportunistic_probe_budget': 24},
        'Adaptive certified search geometry plus bounded en-route optical trials.'),
    ('candidate_060_optical_rollout', {'completion_lookahead': True,
        'joint_service_alternatives': True, 'free_coverage_order': True,
        'preplanned_cross_view': False, 'defer_clear_to_route': True,
        'improve_greedy_route': True, 'shared_stop_measurements': True,
        'optical_probe_limit': 4, 'optical_probe_min_fraction': .25,
        'optical_probe_radius_m': 150., 'refine_certificate': True, 'clear_region_routing': True,
        'opportunistic_probe_budget': 24, 'posterior_completion': True,
        'posterior_clear_rollout': True, 'tail_weight': 0.},
        'Aggressive completion rollout prices optical success and failure, with bounded recovery.'),
    ('candidate_061_adaptive_heptagon', {'completion_lookahead': True,
        'joint_service_alternatives': True, 'free_coverage_order': True,
        'preplanned_cross_view': False, 'defer_clear_to_route': True,
        'improve_greedy_route': True, 'shared_stop_measurements': True,
        'optical_probe_limit': 2, 'refine_certificate': True, 'clear_region_routing': True,
        'adaptive_search_certificate': True, 'aggressive_shared_search': True,
        'adaptive_anchor_positions': True, 'opportunistic_probe_budget': 24,
        'coverage_ring_vertices': 7, 'ring_radius_m': 1300.},
        'Higher-margin seven-vertex ring with certified adaptive pruning and relocation.'),
    ('candidate_062_adaptive_octagon', {'completion_lookahead': True,
        'joint_service_alternatives': True, 'free_coverage_order': True,
        'preplanned_cross_view': False, 'defer_clear_to_route': True,
        'improve_greedy_route': True, 'shared_stop_measurements': True,
        'optical_probe_limit': 2, 'refine_certificate': True, 'clear_region_routing': True,
        'adaptive_search_certificate': True, 'aggressive_shared_search': True,
        'adaptive_anchor_positions': True, 'opportunistic_probe_budget': 24,
        'coverage_ring_vertices': 8, 'ring_radius_m': 1400.},
        'Higher-margin eight-vertex ring with certified adaptive pruning and relocation.'),
]:
    POLICIES[_policy_id] = PolicySpec('dynamic_open_route', 'center_approach',
        {**_OPTIMIZATION_BASE, **_overrides},
        parent_id='candidate_041_dynamic_open_route_deferred_cross_view',
        description=_description, controller='optimized_open_route')
